/**
 * /audit conversion landing page copy (cases-audit-pages.md §C).
 */
export const audit = {
  meta: {
  ...
  after: {
    ...
    steps: [
      'You book a slot',
      'We review your accounts and site',
      '30-minute call: findings you can use, with or without us',
    ],
    note: 'No obligations, no cold-call follow-ups.',
  },
  booking: {
  ...
  riskReducers: [
    { title: 'No obligations', body: 'The findings are yours either way.', icon: 'ClipboardCheck' },
    {
      title: 'Senior eyes only',
      body: 'Reviewed by the people who would run your account.',
      icon: 'Eye',
    },
    {
      title: 'Plain English',
